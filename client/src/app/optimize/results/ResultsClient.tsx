...
export default function ResultsClient() {
  ...
  const [reportId, setReportId] = useState<string>('demo-1234')
  const [analysisData, setAnalysisData] = useState<any>(null)

  // Read `id` from the URL on the client to avoid using `useSearchParams()`
  useEffect(() => {
    try {
      ...
      console.error('Failed to read search params', e)
    }
  }, [])
