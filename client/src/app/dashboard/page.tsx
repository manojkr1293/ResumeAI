...
const getTargetRole = (resume: any) => {
  ...
  const firstRole = Array.isArray(experience) ? experience.find((item: any) => item?.position)?.position : '';
    ...
    <div className="min-h-screen bg-slate-50">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex min-h-16 flex-col gap-3 py-3 sm:flex-row sm:items-center sm:justify-between">
            <Link href="/dashboard" className="flex items-center gap-2">
              ...
              <div>
                <h1 className="text-base font-semibold text-slate-950">ResumeAI</h1>
                <p className="text-xs text-slate-500">Resume dashboard</p>
              </div>
            </Link>
      ...
      <main className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <div className="mb-6 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">
              Create, tailor, duplicate, and manage resumes for different job roles.
            </p>
          </div>
              ...
              <div className="absolute right-0 z-10 mt-2 w-64 rounded-lg border border-slate-200 bg-white p-2 shadow-lg">
                ...
                >
                  ...
                  <span>
                    ...
                    <span className="block text-xs text-slate-500">Start step by step from scratch.</span>
                  </span>
                </button>
                <button
                  type="button"
                ...
                >
                  ...
                  <span>
                    ...
                    <span className="block text-xs text-slate-500">Use your profile data and AI suggestions.</span>
                  </span>
                </button>
              </div>
            )}
        ...
        <div className="mb-6 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          <StatCard label="Total Resumes" value={stats.total.toString()} helper="All active resumes" />
          <StatCard label="Ready Resumes" value={stats.ready.toString()} helper="ATS score 75+" />
          <StatCard label="Average ATS" value={stats.averageAts ? `${stats.averageAts}%` : '-'} helper="Across scored resumes" />
          ...
          <div className="mt-6 rounded-lg border border-slate-200 bg-white p-4">
            ...
            <div className="mt-3 space-y-2">
              {resumes.slice(0, 3).map((resume) => (
                <div key={`activity-${resume.id}`} className="flex items-center justify-between gap-4 text-sm">
  ...
  return (
    <div className="rounded-lg border border-dashed border-slate-300 bg-white px-6 py-14 text-center">
      ...
      <p className="mx-auto mt-2 max-w-md text-sm text-slate-500">
        Start with a blank step-by-step builder or use your profile data to move faster.
      </p>
...
function ResumeCard({
  ...
  return (
    <article className={`rounded-lg border bg-white p-5 shadow-sm transition hover:border-slate-300 hover:shadow-md ${
      ...
      {summary ? (
        ...
        <p className="mb-4 min-h-10 text-sm leading-6 text-slate-400">No summary yet. Add one to make this resume easier to evaluate.</p>
      )}
